...
const CustomTabBar = ({ scrollY, ...props }) => {
...
const TabsViewer = ({ scrollY }) => {
    const TabDisplay = () => <List {...{ scrollY }} />;
    const TabBar = (props) => <CustomTabBar {...{ scrollY }} {...props} />;
    return (
        <Tab.Navigator
            tabBar={TabBar}
            screenOptions={{
        ...
        >
            <Tab.Screen name="My Feed" component={TabDisplay} />
            <Tab.Screen name="Featured" component={TabDisplay} />
            <Tab.Screen name="Recent" component={TabDisplay} />
        </Tab.Navigator>
    );
};

const ScreenHeader = ({ scrollY }) => {
    const animatedStyle = useAnimatedStyle(() => {
        const y = interpolate(
            scrollY.value,
            [0, HEADER_HEIGHT],
